...
from app.models.advertisement import Category, SubCategory, Advertisement, AdImage
from app.models.base_class import Base
from app.repositories.advertisement import AdvertisementRepository
from app.schemas.advertisement import CategorySchema, SubCategorySchema, UpdateAdvertisementSchema
...
class AdvertisementService:
    ...
    async def create_instance(self, model: Type[Base], data: BaseModel) -> Optional[Base]:
    ...
    async def delete_instance(self, model: Type[Base], field: InstrumentedAttribute, value: Any) -> dict:
    ...
    async def update_instance(self, model: Type[Base], value: Any, schema: UpdateAdvertisementSchema):
